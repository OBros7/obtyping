...
const setTypeList = ['set_text', 'set_category', 'set_deck']
    ...
    <>
      <div className='flex flex-col w-full p-4 m-4 outline outline-blue-200'>
        <div className={minibox}>
          Data Type:
          <MySelect state={dataType} setState={setDataType} optionValues={dataTypeList} />
        </div>

        <div className={minibox}>
          User ID:
          <MyInputNumber state={userID} setState={setUserID} min={1} max={100} step={1} defaultState={1} />
        </div>
        <div className={minibox}>
          Visibility:
          <MySelect state={visibility} setState={setVisibility} optionValues={visibilityOptions} />
        </div>
      </div>
      <div className='flex flex-col w-full p-2 outline outline-blue-200'>
        ...
        <div className={minibox}>
          <button className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded' onClick={setData}>
            Create Data
          </button>
          {msg}
        </div>
